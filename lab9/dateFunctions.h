...
/* We use an enum for this so we can easily expand it. */
typedef enum 
   {
   DATE_OK,
   ERR_BADYEAR,   /* year must be between 1900 to 2100 inclusive */
   ERR_BADMONTH,  /* month is something other than 1 to 12 */
   ERR_BADDAY,    /* day is outside of possible range for the month */
   ERR_BADFORMAT  /* date string is not ten chars, or not all digits,*/
